    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return stripe.redirecttToCheckout({
...
var _require3 = require('./updateSettings'),
  updateSettings = _require3.updateSettings;
var _require4 = require('./stripe'),
  bookTour = _require4.bookTour;
var _require5 = require('./alerts'),
  showAlert = _require5.showAlert;
